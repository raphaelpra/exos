...
# %% {"cell_style": "split", "slideshow": {"slide_type": ""}, "trusted": true}
# copie de la 1ère version
def translate(f, x0, y0):
    def translated(x, y):
        return f(x-x0, y-y0)
    return translated
...
# %% {"cell_style": "split", "slideshow": {"slide_type": "slide"}, "trusted": true}
...
# %% {"slideshow": {"slide_type": ""}, "trusted": true}
